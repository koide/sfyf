...
var Engine = (() => { // eslint-disable-line no-unused-vars, no-var
	...
	*/
	function enginePlay(title, noHistory) {
		...
		// This portion has been commented out so that the passages are continuously appended, like a chatbot/messenger app.
		/*
		...
		*/
		...
		// This removes the soon-to-be previous links, so that only the passage text remains
		jQuery('.link-internal').remove();
